...
import ai.nina.labs.sapcclint.catalog.findAttributesByQualifier
import ai.nina.labs.sapcclint.catalog.findCollectionTypes
import ai.nina.labs.sapcclint.catalog.hasLocalDeclaredType
import ai.nina.labs.sapcclint.catalog.findEnumTypes
import ai.nina.labs.sapcclint.catalog.findItemTypes
import ai.nina.labs.sapcclint.catalog.findIndexedAttributeQualifiers
import ai.nina.labs.sapcclint.catalog.findMapTypes
import ai.nina.labs.sapcclint.catalog.findRelations
import ai.nina.labs.sapcclint.catalog.findRelationEndsByQualifier
import ai.nina.labs.sapcclint.catalog.isSameOrSubtypeOf
...
import ai.nina.labs.sapcclint.impex.model.ImpexHeaderBlock
import ai.nina.labs.sapcclint.impex.model.ImpexHeaderParameter
import ai.nina.labs.sapcclint.impex.model.ImpexModifier
import ai.nina.labs.sapcclint.impex.model.ImpexParameter
import ai.nina.labs.sapcclint.impex.model.ImpexReference
import ai.nina.labs.sapcclint.impex.model.ImpexReferenceKind
import ai.nina.labs.sapcclint.impex.model.ParsedImpexFile
import ai.nina.labs.sapcclint.impex.parser.ImpexParser
import ai.nina.labs.sapcclint.itemsxml.model.LocatedValue
import ai.nina.labs.sapcclint.itemsxml.model.SourcePosition
import ai.nina.labs.sapcclint.project.ProjectSupportLoader
...
class ImpexDomainAnalyzer(
    ...
    private fun buildRowContext(
        block: ImpexHeaderBlock,
        valueLine: ai.nina.labs.sapcclint.impex.model.ImpexValueLine,
    ): ValueRowContext? {
        val columnValues = linkedMapOf<String, ai.nina.labs.sapcclint.impex.model.ImpexValueGroup>()
    ...
    private fun resolveHeaderParameterAttributes(
        ...
        ownerTypes: Set<String>,
        support: ImpexSupportContext,
    ): List<ai.nina.labs.sapcclint.catalog.AttributeRecord> {
...
private data class ResolvedHeaderParameterCandidate(
    val file: Path,
    val parameter: ImpexHeaderParameter,
    val resolvedAttributes: List<ai.nina.labs.sapcclint.catalog.AttributeRecord>,
)
...
private data class ValueRowContext(
    val block: ImpexHeaderBlock,
    val valueLine: ai.nina.labs.sapcclint.impex.model.ImpexValueLine,
    val columnValues: Map<String, ai.nina.labs.sapcclint.impex.model.ImpexValueGroup>,
)
...
private val allowedStaticEnumModes = setOf(
    ai.nina.labs.sapcclint.impex.model.ImpexHeaderMode.UPDATE,
    ai.nina.labs.sapcclint.impex.model.ImpexHeaderMode.REMOVE,
)
